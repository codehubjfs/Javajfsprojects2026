...
import com.ecommerce.ui.AdminMenu;
import com.ecommerce.ui.CustomerMenu;
				...
				case 1: // Login
				    ...
				    while (attempts < 3) {
				        try {
				            ...
				            com.ecommerce.models.User user = AuthService.login(email, password); 
				            ...
				            if ("admin".equalsIgnoreCase(user.getRole())) {
				                ...
				                CustomerMenu.customerMenu(s, (com.ecommerce.models.Customer) user);
				            }
